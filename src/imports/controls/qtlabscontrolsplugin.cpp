...
void QtLabsControlsPlugin::registerTypes(const char *uri)
{
    ...
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/Button.qml"))), uri, 1, 0, "Button");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/CheckBox.qml"))), uri, 1, 0, "CheckBox");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/Dial.qml"))), uri, 1, 0, "Dial");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/Drawer.qml"))), uri, 1, 0, "Drawer");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/Frame.qml"))), uri, 1, 0, "Frame");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/GroupBox.qml"))), uri, 1, 0, "GroupBox");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/Label.qml"))), uri, 1, 0, "Label");
    ...
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/TabBar.qml"))), uri, 1, 0, "TabBar");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/TabButton.qml"))), uri, 1, 0, "TabButton");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/TextArea.qml"))), uri, 1, 0, "TextArea");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/TextField.qml"))), uri, 1, 0, "TextField");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/ToolBar.qml"))), uri, 1, 0, "ToolBar");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/ToolButton.qml"))), uri, 1, 0, "ToolButton");
    qmlRegisterType(selector.select(QUrl(base + QStringLiteral("/Tumbler.qml"))), uri, 1, 0, "Tumbler");
}
