...
extern const Q_QMLCOMPILER_EXPORT QQmlSA::LoggerWarningId qmlMaxWarningsExceeded;
...
extern const Q_QMLCOMPILER_EXPORT QQmlSA::LoggerWarningId qmlTypeInstantiatedRecursively;
