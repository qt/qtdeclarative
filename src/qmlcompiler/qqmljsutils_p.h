...
*/
template <typename String = QString, typename CharacterLiteral = QLatin1Char,
          typename StringView = QLatin1StringView>
String toLiteral(const String &s, StringView ctor = StringView("QStringLiteral"))
{
    return ctor % StringView("(\"") % escapeString<String, CharacterLiteral, StringView>(s)
            % StringView("\")");
}
...
*/
inline QString constRefify(QString type)
{
    if (!type.endsWith(u'*'))
        type = u"const " % type % u"&";
    return type;
...
inline std::optional<QQmlJSMetaProperty> changeHandlerProperty(const QQmlJSScope::ConstPtr &scope,
...
inline std::optional<QQmlJSMetaProperty>
...
inline bool hasCompositeBase(const QQmlJSScope::ConstPtr &scope)
{
    if (!scope)
        return false;
...
*/
inline bool bindablePropertyHasDefaultAccessor(const QQmlJSMetaProperty &p,
...
ResolvedAlias Q_QMLCOMPILER_EXPORT resolveAlias(const QQmlJSTypeResolver *typeResolver,
                                                const QQmlJSMetaProperty &property,
                                                const QQmlJSScope::ConstPtr &owner,
                                                const AliasResolutionVisitor &visitor);
ResolvedAlias Q_QMLCOMPILER_EXPORT resolveAlias(const QQmlJSScopesById &idScopes,
                                                const QQmlJSMetaProperty &property,
                                                const QQmlJSScope::ConstPtr &owner,
                                                const AliasResolutionVisitor &visitor);
...
*/
template <typename Action>
void traverseFollowingMetaObjectHierarchy(const QQmlJSScope::ConstPtr &scope,
...
std::optional<QQmlJSFixSuggestion>
        Q_QMLCOMPILER_EXPORT didYouMean(const QString &userInput, QStringList candidates,
                                        const QString &filename,
                                        const QQmlJS::SourceLocation &location);

std::variant<QString, QQmlJS::DiagnosticMessage> Q_QMLCOMPILER_EXPORT
sourceDirectoryPath(const QQmlJSImporter *importer, const QString &buildDirectoryPath);

template <typename Container>
inline void deduplicate(Container &container)
{
...
inline QStringList cleanPaths(QStringList &&paths)
{
...
QString Q_QMLCOMPILER_EXPORT qmlSourcePathFromBuildPath(const QQmlJSResourceFileMapper *mapper,
                                                        const QString &pathInBuildFolder);
QString Q_QMLCOMPILER_EXPORT qmlBuildPathFromSourcePath(const QQmlJSResourceFileMapper *mapper,
                                                        const QString &pathInBuildFolder);

QString Q_QMLCOMPILER_EXPORT getScopeName(const QQmlJSScope::ConstPtr &scope,
...
bool Q_QMLCOMPILER_EXPORT canCompareWithQObject(const QQmlJSTypeResolver *typeResolver,
                                                const QQmlJSScope::ConstPtr &lhsType,
                                                const QQmlJSScope::ConstPtr &rhsType);

bool Q_QMLCOMPILER_EXPORT canCompareWithQUrl(const QQmlJSTypeResolver *typeResolver,
                                             const QQmlJSScope::ConstPtr &lhsType,
                                             const QQmlJSScope::ConstPtr &rhsType);
}; // namespace QQmlJSUtils
