...
T.CheckDelegate {
    ...
    leftPadding: checkLayout.padding.left
    rightPadding: checkLayout.padding.right
    topPadding: checkLayout.padding.top
    bottomPadding: checkLayout.padding.bottom
    ...
    StyleReader {
        id: styleReader
        controlType: StyleReader.CheckDelegate
