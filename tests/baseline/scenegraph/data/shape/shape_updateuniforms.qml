...
// combinations of fill on/off, stroke on/off, with different colors
// for each step
...
Rectangle {
    ...
    readonly property var fillColors: ["cyan", "yellow", "magenta"]
    readonly property var strokeColors: ["blue", "darkgreen", "navy"]
    property int step: 0
                ...
                Repeater {
                    ...
                    Shape {
                        ...
                        ShapePath {
                            ...
                            fillColor: (state & 1) ? root.fillColors[root.step] : "transparent"
                            strokeColor: (state & 2) ? root.strokeColors[root.step] : "transparent"
                            strokeWidth: 6
