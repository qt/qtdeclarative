...
// Same as CoffeeFormOld but with a fifth CoffeeCard (macchiato_for_ulf)
// added at the end and the cappuccino name changed.
...
Item {
    ...
    GridLayout {
        ...
        CoffeeCard {
            id: cappuccino
            coffeeName: "Cappuccinooooooooooooo"
        ...
        CoffeeCard {
            id: macchiato_for_ulf
            coffeeName: "Macchiato for Ulf"
            ingredients: "Milk foam, Espresso"
            time: 4
        }
    }
